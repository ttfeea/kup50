...
```
cd existing_repo
git remote add origin https://gitlab.com/sofiiatarasenko/kup50.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/sofiiatarasenko/kup50/-/settings/integrations)
